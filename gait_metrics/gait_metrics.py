...
def download_and_extract_model(model_name: str, zip_url: str) -> str:
    ...
    Args:
        model_name (str): Name of the model file (e.g., 'gait_detection_model.pt').
...
MODEL_URLS = {
    "gait_detection_model.pt": (
        "https://github.com/yonbrand/gait-metrics/releases/download/v0.1.0/gait_detection_model.pt.zip"
    ),
    "step_count_model.pt": (
        "https://github.com/yonbrand/gait-metrics/releases/download/v0.1.0/step_count_model.pt.zip"
    ),
    "gait_speed_model.pt": (
        "https://github.com/yonbrand/gait-metrics/releases/download/v0.1.0/gait_speed_model.pt.zip"
    ),
    "cadence_model.pt": (
        "https://github.com/yonbrand/gait-metrics/releases/download/v0.1.0/cadence_model.pt.zip"
    ),
    "stride_length_model.pt": (
        "https://github.com/yonbrand/gait-metrics/releases/download/v0.1.0/stride_length_model.pt.zip"
    ),
    "regularity_model.pt": (
        "https://github.com/yonbrand/gait-metrics/releases/download/v0.1.0/regularity_model.pt.zip"
    ),
}
